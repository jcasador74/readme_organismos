...
MatterSede es un web component que genera el elemento "Sede electrónica". Forma parte del catálogo corporativo de Web Components de la Junta de Andalucía.
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: "./demo/matter-sede.stories.js", to: 'story' + '/' + PackageType + '/' + PackageName },
      ],
    }),  ],
