...
MatterFeedback es un web component que genera el elemento "Valoración de contenidos". Forma parte del catálogo corporativo de Web Components de la Junta de Andalucía.
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: "./demo/matter-feedback.stories.js", to: 'story' + '/' + PackageType + '/' + PackageName },
      ],
    }),  ],
