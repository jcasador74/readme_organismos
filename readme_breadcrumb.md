...
MatterBreadcrumb es un web component que genera el elemento "Rastro de migas". Forma parte del catálogo corporativo de Web Components de la Junta de Andalucía.
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: "./demo/matter-breadcrumb.stories.js", to: 'story' + '/' + PackageType + '/' + PackageName },
      ],
    }),  ],
