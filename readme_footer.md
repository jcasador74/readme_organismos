...
MatterFooter es un web component que genera el elemento "Footer". Forma parte del catálogo corporativo de Web Components de la Junta de Andalucía.
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: "./demo/matter-footer.stories.js", to: 'story' + '/' + PackageType + '/' + PackageName },
      ],
    }),  ],
