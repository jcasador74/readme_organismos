...
MatterPagination es un web component que genera el elemento "Paginador". Forma parte del catálogo corporativo de Web Components de la Junta de Andalucía.
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: "./demo/matter-pagination.stories.js", to: 'story' + '/' + PackageType + '/' + PackageName },
      ],
    }),  ],
