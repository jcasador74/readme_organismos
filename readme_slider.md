...
MatterSlider es un web component que genera el elemento "Slider". Forma parte del catálogo corporativo de Web Components de la Junta de Andalucía.
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: "./demo/matter-slider.stories.js", to: 'story' + '/' + PackageType + '/' + PackageName },
      ],
    }),  ],
